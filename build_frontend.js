...
.btn { padding: 0.65rem 1.6rem; border: none; border-radius: 2px; cursor: pointer; font-weight: 600; font-size: 0.78rem; transition: 0.3s; text-transform: uppercase; text-decoration: none; display: inline-block; }
